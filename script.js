const buttonMap = {
  en: [
    ...
    { label: "Minimum Amount", shortcode: "min_amt_en" },
    { label: "Maximum Amount", shortcode: "max_amt_en" },
    { label: "Max Amt (Lakh)", shortcode: "max_amt_lakh_en" },
  ...
  hi: [
    ...
    { label: "Minimum Amount", shortcode: "min_amt_hi" },
    { label: "Maximum Amount", shortcode: "max_amt_hi" },
  ...
  mr: [
    ...
    { label: "Minimum Amount", shortcode: "min_amt_mr" },
    { label: "Maximum Amount", shortcode: "max_amt_mr" },
  ...
  ta: [
    ...
    { label: "Minimum Amount", shortcode: "min_amt_ta" },
    { label: "Maximum Amount", shortcode: "max_amt_ta" },
